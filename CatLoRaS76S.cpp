...
float CatLoRaS76S::readTemperature()
{
    return smeHumidity.readTemperature();
}
float CatLoRaS76S::readHumidity()
{
    return smeHumidity.readHumidity();
}
String CatLoRaS76S::getCayenneLPPformat()
{
    String temp = "";
    String humi = "";
    ...
    temp = uint16_t(this->readTemperature() * 10);
    humi = uint16_t(this->readHumidity() * 2);
    char tempHex[5];
    char humiHex[3];
